...
class SddcConnections(VapiInterface):
    ...
    def get(self,
        ...
        :rtype: :class:`com.vmware.vmc.model_client.AwsSddcConnection`
        :return: com.vmware.vmc.model.AwsSddcConnection
        :raise: :class:`com.vmware.vapi.std.errors_client.Unauthenticated` 
             Unauthorized
        :raise: :class:`com.vmware.vapi.std.errors_client.Unauthorized` 
             Forbidden
    ...
    def __init__(self, config):
        ...
        operations = {
            ...
            'post': {
                ...
                'input_validator_list': post_input_validator_list,
...
class _SddcConnectionsStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        operations = {
            'get': {
                'input_type': get_input_type,
                'output_type': type.ReferenceType('com.vmware.vmc.model_client', 'AwsSddcConnection'),
                'errors': get_error_dict,
                'input_validator_list': get_input_validator_list,
                'output_validator_list': get_output_validator_list,
            },
